...
legend_txt = {};
id = 1;
setting{id}.learning_rate = 1e+3;    % Learning rate
...
if strcmp(data_name, 'cora') || strcmp(data_name, 'pubmed') %------------------
  ...
  szW0 = [d,c];        % Size of parameter matrix W0
...
for i = 1:num_setting
  ...
  [loss_hist{i}, ~, true_loss_hist{i}] = ...
      model_1layer_train_and_test(...
      A, X, Y, idx_train, idx_valid, idx_test, szW0, l2_reg, ...
