function [L, P, dLdW0, dLdW1] = model_fastgcn(A, X, AX, Y, idx0, idx1, idx2, p0, p1, W0, W1, l2_reg)
% This code implements the FastGCN model, which includes as a special
% case the batched GCN model when sampling is not applied. The
